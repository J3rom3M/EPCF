        ...
        <nav class="navbar navbar-dark bg-dark">
          <div class="container-fluid">
            ...
            <form class="d-flex">
              ...
              <button class="btn btn-light" onclick="window.location.href = 'http://127.0.0.1:9090/search';" type="submit" id="submit">Search</button>
            </form>
          </div>
        </nav>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="http://127.0.0.1:9090/search">Search</a>
                </li>
              </ul>
            </div>
          </div>
