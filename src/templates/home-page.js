      ...
      <main id="market" class="container-fluid">
        <section class="market--content-1 row pt-3 pb-5 bg-light">
          ...
          <div class="col-8">
            ...
            <div class="d-grid gap-2 mt-2">
              <button type="button"  onclick="window.location.href = 'http://127.0.0.1:9090/dashboard';" class="btn btn-primary">Accéder gratuitement au dashboard</button>
            </div>
          </div>
          <div class="col-2"></div>
        </section>
        <section class="market--content-1 row pt-3 pb-5 mt-5 mb-5" >
          ...
          <div class="col-8">
            <div class="row">
              <div class="col-4">
                <img class="img-fluid" src="https://img.icons8.com/cute-clipart/64/000000/walter-white.png" alt="image">
              </div>
              <div class="col-8">
        ...
        <section class="market--content-1 row pt-3 pb-5 mt-5 mb-5" >
          ...
          <div class="col-8">
            <div class="row">
              ...
              <div class="col-4">
                <img class="img-fluid" src="https://img.icons8.com/cute-clipart/64/000000/luigi.png" alt="image">
              </div>
            </div>
          </div>
          <div class="col-2"></div>
